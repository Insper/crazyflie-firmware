...
#define ACC_ADD 0b0011000 << 1  // Shift 1 bit left because mbed utilizes 8-bit addresses and not 7-bit
...
// Accerometer output register addresses
...
// Gyroscope I2C bus address
#define GYR_ADD 0b1101001 << 1  // Shift 1 bit left because mbed utilizes 8-bit addresses and not 7-bit
...
class BMI088
{
    ...
    private:
        ...
        bool test_i2c();         
        // Setup accelerometer
        void setup_acc(acc_range a_scale = ACC_RANGE_12G, acc_odr a_odr = ACC_ODR_100);
        // Setup gyroscope
        void setup_gyr(gyr_range g_scale = GYR_RANGE_500DPS, gyr_odr g_odr = GYR_ODR_2000);
